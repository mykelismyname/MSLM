...
_LICENSE = ""
_DATA_URL = ""
EMB_COMET_LABELS = ["O", "B-Adverse-effects", "B-Life-Impact", "B-Mortality", "B-Physiological-Clinical",
                    "B-Resource-use", "I-Adverse-effects", "I-Life-Impact", "I-Mortality", "I-Physiological-Clinical",
                    "I-Resource-use"]
                ...
                if doc:
                    ...
                    for ent in doc['Entities']:
                        ...
                        try:
                            ...
                            ent_tags[0] = f"B-{tag}"
                            if all(i in EMB_COMET_LABELS for i in ent_tags):
