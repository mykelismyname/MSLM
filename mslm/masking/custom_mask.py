...
def customMask(tokenized_input, tokenizer, labels_list, mask_id, custom_mask=False):
    ...
    if custom_mask:
        ...
        for i, j in enumerate(tokenized_input):
            ...
            # print(entity_mask_ids)
            print("\n", mask_)
            # print(non_entity_mask_ids)
            # print("==============================================================================================================")
        ...
        tokenized_input_ = tokenized_input_.add_column(name='mask_specific_ids', column=[(entity_mask_ids), (non_entity_mask_ids)])
        n = 0
